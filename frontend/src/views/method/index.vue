<template>
  <section class="page" data-module="method">
    <header class="page-head">
      <div>
        <h2>检测方法管理</h2>
        <p class="page-desc">维护检测方法，围绕方法编号、方法名称、适用标准、检测范围做登记、筛选与状态流转。</p>
      </div>
    ...
    <table class="data-table">
      ...
      <tbody>
        ...
        <tr v-if="!rows.length">
          <td :colspan="columns.length + 1" class="empty-state">暂无检测方法数据，可先登记检测方法</td>
        </tr>
      </tbody>
    </table>
...
const columns = ["方法编号", "方法名称", "适用标准", "检测范围", "检出限", "方法版本", "批准日期", "方法状态"]
const actions = ["发起验证", "确认有效", "废止方法"]
const statuses = ["草案", "验证中", "现行有效", "已废止"]
const stats = [{"label": "现行方法", "value": 0}, {"label": "验证中方法", "value": 0}, {"label": "废止方法", "value": 0}]
